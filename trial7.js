document.addEventListener('DOMContentLoaded', () => {
    ...
    button.addEventListener('click', () => {
        ...
        function isInvalidDayForMonth(day, month) {
            const daysInMonth = [0, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
        ...
        if (isDDRequired || isMMRequired || isYYRequired) {
            ...
            changeBorderColor(false);
            changeTextColor(false);
        } else if (isInvalidDayForMonth(inputDD, inputMM)) {
            showErrorMessages("Invalid day for the selected month", "Invalid day for the selected month", "");
            changeBorderColor(false);
            changeTextColor(false);
        } else {
            showErrorMessages("", "", "");
